...
public:
   ...
   * \param[in] components_to_not_load list of component names that should be excluded from loading
  ...
  load_and_initialize_components(
    ...
    const std::vector<std::string> & components_to_not_load = std::vector<std::string>());
